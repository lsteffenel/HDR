...
La découverte de topologie a un rôle très significatif dans notre travail, car son utilité réside notamment dans l'identification dh'étérogénéités sur une grille de calcul. Cette identification est très importante dans le contexte d'une grille de calcul, une fois que la présence d'hétérogénéités augmente la complexité des modèles et réduit la précision des prédictions de performance.
